...
namespace MaintenanceToolECSBOX
{
    ...
    public class EventHandlerForDevice
    {
        ...
        public bool configurationUpdated = false;
        ...
        public void SetDeafultParameters()
        {
            eventHandlerForDevice.Device.BaudRate = DeviceConfiguration.BaudRate;
            eventHandlerForDevice.Device.Parity = DeviceConfiguration.Parity;
            eventHandlerForDevice.Device.StopBits = DeviceConfiguration.StopBits;
            eventHandlerForDevice.Device.Handshake = DeviceConfiguration.Handshake;
            ...
            eventHandlerForDevice.Device.ReadTimeout = new System.TimeSpan(0,0,0,400);

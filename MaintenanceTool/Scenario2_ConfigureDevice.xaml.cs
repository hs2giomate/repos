    ...
    public sealed partial class Scenario2_ConfigureDevice : Page
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs eventArgs)
        {
            ...
            else
            {
                ...
                UpdateConfigurationSerial();
            }
        }
        public  void UpdateConfigurationSerial()
        {
            UpdateBaudRateView();
            UpdateParityView();
            UpdateHandShakeView();
            ...
            EventHandlerForDevice.Current.configurationUpdated = true;
        }

        private void UpdateBaudRateView()
        {
            if (EventHandlerForDevice.Current.Device.BaudRate==0)
            {
                EventHandlerForDevice.Current.Device.BaudRate = DeviceConfiguration.BaudRate;
            }
        ...
        {
            if (EventHandlerForDevice.Current.Device.DataBits==0)
            {
                EventHandlerForDevice.Current.Device.DataBits = DeviceConfiguration.DataBits;
            }
        ...
        private void ConfigureDeviceScrollViewer_ViewChanged(object sender, ScrollViewerViewChangedEventArgs e)
        {
